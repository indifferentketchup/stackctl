...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center gap-1 rounded-md border border-border bg-card p-1 text-muted-foreground',
      className
    )}
    {...props}
  />
